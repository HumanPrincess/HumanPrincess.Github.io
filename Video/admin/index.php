...
if($_COOKIE['x_Cookie'] == $用户名 and $_COOKIE['y_Cookie'] == $密码){
 ...
 <div class="login">
 <div class="login-l">
	<div class="login-title">解析站后台</div>
...
<div class="index-nav">
	<ul>
		<li><a target="_blank" href="https://www.235w.com/" rel="nofollow"><img src="../imglogo/kxd.png" width="110" height="35"></a></li>
		<li><a href="../index.php" target="_blank" >网站前台</a></li>
		<li><a href="?">基本设置</a></li>
		<li><a href="?sort=admin">修改密码</a></li>
		<li><a href="https://www.235w.com/" target="_blank" >返回235资源网</a></li>
	</ul>
</div>
...
<input  type="submit" value="保存修改" class="buttontxt">
 ...
 <?php }?>
 <div class="index-f">
	<p>Copyright © 2017 <a href="https://www.235w.com/" target="_blank"  >235资源网</a>  版权所有. 丨 <a href="https://www.235w.com/">VIP解析V2.5版本</a></p>
</div>
</div>
</div>
 </body></html>